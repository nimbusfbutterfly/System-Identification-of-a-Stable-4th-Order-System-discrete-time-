...
change_interval = 200; 
num_changes = max / change_interval;
lambda =1;
P = 1000 * eye(8);
theta = zeros(8, 1);
...
for t = 8:max
    if mod(t, change_interval) == 0
        a0_true = a0_true + 0.0002 * randn(1);
        a1_true = a1_true + 0.0002 * randn(1);
        a2_true = a2_true + 0.0002 * randn(1);
        a3_true = a3_true + 0.0002 * randn(1);
        b1_true = b1_true + 0.0002 * randn(1);
        b2_true = b2_true + 0.0002 * randn(1);
        b3_true = b3_true + 0.0002 * randn(1);
        b4_true = b4_true + 0.0002 * randn(1);
    end
